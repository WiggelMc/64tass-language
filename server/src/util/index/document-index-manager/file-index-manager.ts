import { FileEventEmitter, FileEventListener } from "../file-event-handler";
...
export class DocumentIndexManager<T> extends FileEventEmitter<ProjectIndexManagerMessages<T>> {
